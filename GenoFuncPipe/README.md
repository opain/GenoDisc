# Genomic Analysis of Functional Annotations Pipeline (GenoFuncPipe)
...
The results of all analyses are summarised in an .html report. An example of this report can be found [here](example_report.html).

***

## Using the pipeline

Users can upload their GWAS summary statistics [here](https://opain.shinyapps.io/NEUROHACK_GenoFunc_demo/) for analysis via our King's College London server. Alternatively, users can download the pipeline and run analyses locally (see instructions below).
...
Run pipeline for Coronary Artery Disease GWAS (COAD01).
