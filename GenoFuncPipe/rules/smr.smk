...
rule run_smr_analysis_MetaBrain_Basalganglia:
    input: 
      lambda w: expand("results/{gwas}/smr/metabrain/Basalganglia/{gwas}_smr_metabrain_Basalganglia_chr{chr}.smr", gwas=w.gwas, chr=range(1, 23))
    output: 
      touch('results/{gwas}/checks/metabrain_smr_basalganglia_all_chr.done')

rule run_smr_analysis_MetaBrain_Cerebellum:
    input: 
      lambda w: expand("results/{gwas}/smr/metabrain/Cerebellum/{gwas}_smr_metabrain_Cerebellum_chr{chr}.smr", gwas=w.gwas, chr=range(1, 23))
    output: 
      touch('results/{gwas}/checks/metabrain_smr_cerebellum_all_chr.done')

rule run_smr_analysis_MetaBrain_Cortex:
    input: 
      lambda w: expand("results/{gwas}/smr/metabrain/Cortex/{gwas}_smr_metabrain_Cortex_chr{chr}.smr", gwas=w.gwas, chr=range(1, 23))
    output: 
      touch('results/{gwas}/checks/metabrain_smr_cortex_all_chr.done')

rule run_smr_analysis_MetaBrain_Hippocampus:
    input: 
      lambda w: expand("results/{gwas}/smr/metabrain/Hippocampus/{gwas}_smr_metabrain_Hippocampus_chr{chr}.smr", gwas=w.gwas, chr=range(1, 23))
    output: 
      touch('results/{gwas}/checks/metabrain_smr_hippocampus_all_chr.done')

rule run_smr_analysis_MetaBrain_Spinalcord:
    input: 
      lambda w: expand("results/{gwas}/smr/metabrain/Spinalcord/{gwas}_smr_metabrain_Spinalcord_chr{chr}.smr", gwas=w.gwas, chr=range(1, 23))
    output: 
